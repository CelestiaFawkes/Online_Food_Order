...
public class AuthController {
	...
	public ResponseEntity<AuthResponse> createuserHandler(@RequestBody User user) throws Exception {
		...
		logger.info("User with email '{}' signed up successfully", user.getEmail());
	...
	public ResponseEntity<AuthResponse> signingin(@RequestBody LoginRequest req) {
		...
		logger.info("Signing in user with email '{}'", username);
		...
		logger.info("User with email '{}' signed in successfully", username);
